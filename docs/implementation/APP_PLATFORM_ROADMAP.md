...
| 2 | Generic application runtime | In progress: preflight, resumable provisioning, record/query CRUD and attachments implemented | Real typed records; CRUD, validation, search, filters, sort, pagination, relationships, attachments, authorization and audit history; browser workflow and failure/isolation tests |
