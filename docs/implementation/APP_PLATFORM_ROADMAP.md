...
| 3 | App Builder v1 | In progress: steps 1-4 done (App Builder UI, defaults/ordering, safe populated-schema changes, basic permissions); step 5 (qualification) remaining | No-code model/field/form/list editing; labels, defaults, required flags, ordering, relationships and basic permissions; safe populated-schema changes |
